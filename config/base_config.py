class BaseConfig:
    def __init__(self, x_dimensions, y_dimensions, z_dimensions, output_path, 
                 img_uri, img_res, img_link, seg_uri, seg_res, seg_link, CAVEclient, mesh_ids, mesh_uri, project_name, syglass_directory, shader_settings_to_load_path, annotation_csv_file_path, trace_file_path):
        ...
        self.annotation_csv_file_path = annotation_csv_file_path
